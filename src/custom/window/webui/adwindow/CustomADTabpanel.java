 ...
 * @author Low Heng Sin
 */
public class CustomADTabpanel extends Div implements Evaluatee, EventListener<Event>,
DataStatusListener, CustomIADTabpanel, IdSpace, IFieldEditorContainer
{
    ...
    static
    {
        logger = CLogger.getCLogger(CustomADTabpanel.class);
    }
    ...
    private CustomGridView		  listPanel;
	...
	private CustomADTreePanel treePanel = null;
     ...
     * @param gridWindow
     */
    public void init(CustomAbstractADWindowContent winPanel, int windowNo, GridTab gridTab,
            GridWindow gridWindow)
    {
		...
		if (gridTab.isTreeTab() && AD_Tree_ID != 0)
		{
			...
			treePanel = new CustomADTreePanel(windowNo, gridTab.getTabNo());
			West west = new West();
