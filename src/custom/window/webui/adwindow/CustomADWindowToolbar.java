 ...
 */
public class CustomADWindowToolbar extends FToolbar implements EventListener<Event>
{
	/**
	 *
	 */
    ...
    private static final CLogger log = CLogger.getCLogger(CustomADWindowToolbar.class);
...
//	public int 				lastModifiers;
    ...
    public CustomADWindowToolbar()
    {
    	this(null, 0);
    }

    public CustomADWindowToolbar(CustomAbstractADWindowContent windowContent, int windowNo) {
...
//    }
	...
	private boolean hasAccess(String buttonName) {
		CustomADWindow adwindow = CustomADWindow.get(windowNo);
