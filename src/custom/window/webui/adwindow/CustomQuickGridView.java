...
import org.adempiere.webui.adwindow.QuickGridTabRowRenderer;	//JPIERE
 ...
 * @since Nov 03, 2017
 */
public class CustomQuickGridView extends Vbox
	...
	static CLogger log = CLogger.getCLogger(CustomQuickGridView.class);
	...
	private CustomQuickGridTabRowRenderer renderer;
	...
	public CustomWQuickForm				quickForm;
	 ...
	 */
	public CustomQuickGridTabRowRenderer getRenderer() {
		return renderer;
	}
	 ...
	 * @param windowNo
	 */
	public CustomQuickGridView(int windowNo)
	{
	 ...
	 * @param wQuickForm
	 */
	public CustomQuickGridView(CustomAbstractADWindowContent abstractADWindowContent, GridTab gridTab, CustomWQuickForm wQuickForm)
	{
	...
	private void updateModel() {
		...
		renderer = new CustomQuickGridTabRowRenderer(gridTab, windowNo);
