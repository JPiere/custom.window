 ...
 * - Norbert Bede                                                      *
 **********************************************************************/
package custom.window.webui.apps;

import org.adempiere.webui.ClientInfo;
//import org.adempiere.webui.apps.LabelsSearchController.LabelItem;	//JPIERE
...
import custom.window.webui.apps.CustomLabelsSearchController.LabelItem;

/**
 * Component to search AD_Label* records.
 */
public class CustomLabelsSearch extends Div implements EventListener<Event> {
	/**
	 * generated serial id
	 */
	...
	private CustomLabelsSearchController controller;

	/**
	 * Standard constructor
	 * @param controller
	 */
	public CustomLabelsSearch(CustomLabelsSearchController controller) {
	...
	private void init() {
		...
		addEventListener(CustomLabelsSearchController.ON_POST_SELECT_LABELITEM_EVENT, this);
	...
	public void onEvent(Event event) throws Exception {
		...
		if (event.getName().equals(CustomLabelsSearchController.ON_POST_SELECT_LABELITEM_EVENT)) {
			closePopup();
			bandbox.focus();
