...
package custom.window.webui.panel.action;
...
import custom.window.webui.adwindow.CustomAbstractADWindowContent;//JPIERE
 ...
 */
public class CustomReportAction implements EventListener<Event>
{
	private static final CLogger log = CLogger.getCLogger(CustomReportAction.class);
	 ...
	 * @param panel
	 */
	public CustomReportAction(CustomAbstractADWindowContent panel)
	{
		this.panel = panel;
